...
class GroupFeedPaginationTokenTest {
    ...
    private static final LocalDateTime TEST_TIMESTAMP = LocalDateTime.of(2025, 1, 15, 10, 30, 0);

    @Test
    void encode_WithValidData_ReturnsBase64String() {
        // Given
        GroupFeedPaginationToken token = new GroupFeedPaginationToken(EVENT_ID, TEST_TIMESTAMP);
    ...
    void decode_WithValidToken_ReturnsCorrectData() {
        // Given
        GroupFeedPaginationToken originalToken = new GroupFeedPaginationToken(EVENT_ID, TEST_TIMESTAMP);
    ...
    void encode_WithNullEventId_StillWorks() {
        // Given
        GroupFeedPaginationToken token = new GroupFeedPaginationToken(null, TEST_TIMESTAMP);
    ...
    void encode_WithNullTimestamp_StillWorks() {
        // Given
        GroupFeedPaginationToken token = new GroupFeedPaginationToken(EVENT_ID, null);
