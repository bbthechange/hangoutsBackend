...
## Test and Deployment Guidelines

### Deployment and Testing Process
- When "deploy and test" is requested, this involves:
  - Deploying with a long timeout
  - Creating a test user
  - Logging in with the test user
  - Creating a test event
  - Retrieving all events
  - Retrieving the specific test event
  - Retrieving invites for the event
  - Retrieving predefined images and verifying the result is not empty
  - Deleting the test event
  - Note: Once a user deletion mechanism is implemented, the process should also include removing the test user
